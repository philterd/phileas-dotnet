...
/// <summary>Policy configuration for the Hospital dictionary filter.</summary>
public class Hospital : AbstractPolicyFilter
{
    /// <summary>Gets or sets the list of Hospital filter strategies to apply.</summary>
    [JsonPropertyName("hospitalFilterStrategies")]
    public List<HospitalFilterStrategy>? Strategies { get; set; }
