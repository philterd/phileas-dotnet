...
/// <summary>Policy configuration for the Surname dictionary filter.</summary>
public class Surname : AbstractPolicyFilter
{
    /// <summary>Gets or sets the list of Surname filter strategies to apply.</summary>
    [JsonPropertyName("surnameFilterStrategies")]
    public List<SurnameFilterStrategy>? Strategies { get; set; }
