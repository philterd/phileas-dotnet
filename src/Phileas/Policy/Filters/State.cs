...
/// <summary>Policy configuration for the State dictionary filter.</summary>
public class State : AbstractPolicyFilter
{
    /// <summary>Gets or sets the list of State filter strategies to apply.</summary>
    [JsonPropertyName("stateFilterStrategies")]
    public List<StateFilterStrategy>? Strategies { get; set; }
