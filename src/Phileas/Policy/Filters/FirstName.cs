...
/// <summary>Policy configuration for the FirstName dictionary filter.</summary>
public class FirstName : AbstractPolicyFilter
{
    /// <summary>Gets or sets the list of FirstName filter strategies to apply.</summary>
    [JsonPropertyName("firstNameFilterStrategies")]
    public List<FirstNameFilterStrategy>? Strategies { get; set; }
