...
/// <summary>Policy configuration for the City dictionary filter.</summary>
public class City : AbstractPolicyFilter
{
    /// <summary>Gets or sets the list of City filter strategies to apply.</summary>
    [JsonPropertyName("cityFilterStrategies")]
    public List<CityFilterStrategy>? Strategies { get; set; }
