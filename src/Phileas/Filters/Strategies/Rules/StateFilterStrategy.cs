...
/// <summary>Runtime replacement strategy for the State dictionary filter.</summary>
public class StateFilterStrategy : StandardFilterStrategy
{
    /// <inheritdoc />
