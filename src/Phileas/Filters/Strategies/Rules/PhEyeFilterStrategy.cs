...
/// <summary>
///     Runtime filter strategy for PhEye-detected entity detection. Delegates to
///     <see cref="Phileas.Strategies.StandardFilterStrategy.GetStandardReplacement" /> with <c>FilterType.PhEye</c>.
/// </summary>
