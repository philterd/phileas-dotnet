...
/// <summary>
///     Runtime filter strategy for URL detection. Delegates to
///     <see cref="Phileas.Strategies.StandardFilterStrategy.GetStandardReplacement" /> with <c>FilterType.Url</c>.
/// </summary>
