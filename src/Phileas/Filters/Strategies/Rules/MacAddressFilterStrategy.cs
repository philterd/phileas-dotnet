...
/// <summary>
///     Runtime filter strategy for MAC address detection. Delegates to
///     <see cref="Phileas.Strategies.StandardFilterStrategy.GetStandardReplacement" /> with <c>FilterType.MacAddress</c>.
/// </summary>
