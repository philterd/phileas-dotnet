...
/// <summary>
///     Runtime filter strategy for date expression detection. Delegates to
///     <see cref="Phileas.Strategies.StandardFilterStrategy.GetStandardReplacement" /> with <c>FilterType.Date</c>.
/// </summary>
