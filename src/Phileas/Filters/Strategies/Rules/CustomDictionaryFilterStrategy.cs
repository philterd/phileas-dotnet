...
/// <summary>Runtime replacement strategy for custom-dictionary filters.</summary>
public class CustomDictionaryFilterStrategy : StandardFilterStrategy
{
    /// <inheritdoc />
