...
/// <summary>
///     Runtime filter strategy for Employer Identification Number (EIN) detection. Delegates to
///     <see cref="Phileas.Filters.Strategies.StandardFilterStrategy" /> with <c>FilterType.Ein</c>.
/// </summary>
public class EinFilterStrategy : StandardFilterStrategy
{
    /// <inheritdoc />
