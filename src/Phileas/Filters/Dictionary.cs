...
public class Dictionary : AbstractPolicyFilter
{
    ...
    /// <summary>Gets or sets a value indicating whether fuzzy (approximate) matching is enabled. Defaults to <see langword="false"/>.</summary>
    [JsonPropertyName("fuzzy")]
    public bool Fuzzy { get; set; } = false;

    /// <summary>Gets or sets the fuzzy matching sensitivity level: <c>"low"</c>, <c>"medium"</c>, or <c>"high"</c>. Defaults to <c>"low"</c>.</summary>
