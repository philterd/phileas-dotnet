...
public interface IFilterService
{
    ...
    TextFilterResult Filter(PhileasPolicy policy, string context, int piece, string input, IContextService? contextService = null);
    ...
    EvaluationResult Evaluate(PhileasPolicy policy, string context, int piece, string input, IList<Span> groundTruthSpans, IContextService? contextService = null);
}
