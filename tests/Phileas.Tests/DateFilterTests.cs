...
public class DateFilterTests
{
    ...
    {
        var strategy = new DateFilterStrategy { Strategy = "SHIFT_DATE", ShiftYears = 1 };
    ...
    {
        var strategy = new DateFilterStrategy { Strategy = "SHIFT_DATE", ShiftDays = 10 };
        var result = strategy.GetReplacement("ctx", "01/15/1990", [], 0.9, null, null, null, null);
    ...
    {
        var strategy = new DateFilterStrategy { Strategy = "SHIFT_DATE", ShiftMonths = 2 };
        var result = strategy.GetReplacement("ctx", "01/15/1990", [], 0.9, null, null, null, null);
    ...
    {
        var strategy = new DateFilterStrategy { Strategy = "SHIFT_DATE", ShiftMonths = 1 };
        ...
        var policy = new PhileasPolicy
        {
            ...
            Identifiers = new Identifiers
            {
                Date = new Date
                {
                    ...
                    {
                        new() { Strategy = "SHIFT_DATE", ShiftYears = 1 }
                    }
                }
            }
        };
