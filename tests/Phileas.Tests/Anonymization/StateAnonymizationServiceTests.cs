...
public class StateAnonymizationServiceTests
{
    private const string Token = "Ohio";

    [Fact]
    public void RealisticReplacement()
    {
        var service = new StateAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Realistic);
    ...
    {
        var service = new StateAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Uuid);
        var replacement = service.Anonymize(Token);
        Assert.NotEqual(Token, replacement);
    ...
    public void FromListReplacement()
    {
        ...
        var service = new StateAnonymizationService(new InMemoryContextService(), new Random(), candidates);
    ...
    {
        var service = new StateAnonymizationService(new InMemoryContextService());
