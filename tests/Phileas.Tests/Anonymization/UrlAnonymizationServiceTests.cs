...
public class UrlAnonymizationServiceTests
{
    private const string Token = "http://example.com";

    [Fact]
    public void RealisticReplacement()
    {
        var service = new UrlAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Realistic);
    ...
    {
        var service = new UrlAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Uuid);
        var replacement = service.Anonymize(Token);
        Assert.NotEqual(Token, replacement);
    ...
    public void FromListReplacement()
    {
        ...
        var service = new UrlAnonymizationService(new InMemoryContextService(), new Random(), candidates);
    ...
    {
        var service = new UrlAnonymizationService(new InMemoryContextService());
