...
public class SurnameAnonymizationServiceTests
{
    private const string Token = "Smith";

    [Fact]
    public void RealisticReplacement()
    {
        var service = new SurnameAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Realistic);
    ...
    {
        var service = new SurnameAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Uuid);
        var replacement = service.Anonymize(Token);
        Assert.NotEqual(Token, replacement);
    ...
    public void FromListReplacement()
    {
        ...
        var service = new SurnameAnonymizationService(new InMemoryContextService(), new Random(), candidates);
    ...
    {
        var service = new SurnameAnonymizationService(new InMemoryContextService());
