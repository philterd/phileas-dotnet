...
public class VinAnonymizationServiceTests
{
    private const string Token = "1HGCM82633A004352";

    [Fact]
    public void RealisticReplacement()
    {
        var service = new VinAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Realistic);
    ...
    {
        var service = new VinAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Uuid);
        var replacement = service.Anonymize(Token);
        Assert.NotEqual(Token, replacement);
    ...
    public void FromListReplacement()
    {
        ...
        var service = new VinAnonymizationService(new InMemoryContextService(), new Random(), candidates);
    ...
    {
        var service = new VinAnonymizationService(new InMemoryContextService());
