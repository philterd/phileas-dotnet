...
public class PersonsAnonymizationServiceTests
{
    private const string Token = "John Doe";

    [Fact]
    public void RealisticReplacement()
    {
        var service = new PersonsAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Realistic);
    ...
    {
        var service = new PersonsAnonymizationService(new InMemoryContextService(), new Random(), AnonymizationMethod.Uuid);
        var replacement = service.Anonymize(Token);
        Assert.NotEqual(Token, replacement);
    ...
    public void FromListReplacement()
    {
        ...
        var service = new PersonsAnonymizationService(new InMemoryContextService(), new Random(), candidates);
    ...
    {
        var service = new PersonsAnonymizationService(new InMemoryContextService());
